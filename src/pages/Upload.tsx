...
const Upload = () => {
  ...
  const [isSmartDataEnabled, setIsSmartDataEnabled] = useState(false);
  ...
  const handleSmartDataToggle = (event: ChangeEvent<HTMLInputElement>) => {
    setIsSmartDataEnabled(event.target.checked);
  };
  ...
  const handleSubmitDetails = (event) => {
    ...
    fetch("https://run.mocky.io/v3/77def4aa-479a-4e2d-be84-9358a44f86ef")
      .then((response) => {
        if (response.ok) {
      ...
      .then((statusResult) => {
        if (
          statusResult &&
          statusResult.creditHistoryStatus &&
          statusResult.creditHistoryStatus === 0
        ) {
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-brand-700 dark:text-brand-300">
                  All documents are encrypted during upload and processing. We
                  use bank-grade security and never store your documents longer
                  than necessary for analysis.
                </p>
              </div>
            </div>
          </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-start space-x-3">
                ...
                >
                  ...
                  and consent to the secure processing of my financial data for
